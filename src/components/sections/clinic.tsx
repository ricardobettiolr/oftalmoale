...
const photos = [
  {
    ...
    caption:
      "Evaluación oftalmológica especializada — Dra. María Alejandra Rojas durante una evaluación con lámpara de hendidura.",
    className:
  ...
  },
  {
    ...
    caption:
      "Oftalmoale — Consultorio de la Dra. María Alejandra Rojas en Mérida, Venezuela.",
    className:
  ...
  },
  {
    ...
    caption:
      "Precisión en cada evaluación — Exploración clínica orientada a obtener la información necesaria para un diagnóstico y tratamiento adecuados.",
    className:
